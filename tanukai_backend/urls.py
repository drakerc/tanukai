...
urlpatterns = [
    ...
    re_path(
        r"^api/v1/uploaded-image-search/(?P<image_id>[0-9]+)$",
        UploadedImageSearch.as_view(),
    ),
    re_path(
        r"^api/v1/database-image-search/(?P<image_id>[0-9]+)$",
        DatabaseImageSearch.as_view(),
    ),
