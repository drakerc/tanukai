...
class ImageFinder:
    ...
    def get_marked_found_image(
        self, small_image: np.ndarray, large_image: np.ndarray
    ) -> Optional[str]:
        """
        ...
        """
        try:
            x_coordinate, y_coordinate, similarity = self.find_image(
        ...
        cv2.rectangle(
            ...
            (x_coordinate + tcols, y_coordinate + trows),
            (0, 0, 255),
            2,
        )
